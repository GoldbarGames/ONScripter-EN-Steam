...
{
    short unsigned int cell_width = image_surface->w/num_of_cells;
    SDL_Rect cliprect = {0, 0, (short unsigned int) cell_width, (short unsigned int) image_surface->h};
                                    ...
                                    SDL_Rect &clip, int alpha )
{
    ...
    SDL_Rect dst_rect = { (short int) dst_x, (short int) dst_y, pos.w, pos.h}, src_rect;
                               ...
                               bool rotate_flag )
{
    ...
    SDL_Rect dst_rect = { (short int) dst_x, (short int) dst_y, (short unsigned int) surface->w, (short unsigned int) surface->h};
    if (rotate_flag){
    ...
    /* ---------------------------------------- */
    /* 2nd clipping */
    SDL_Rect clip_rect = {0, 0, (short unsigned int) image_surface->w, (short unsigned int) image_surface->h};
...
void AnimationInfo::copySurface( SDL_Surface *surface, SDL_Rect *src_rect, SDL_Rect *dst_rect )
{
    ...
    SDL_Rect _dst_rect = {0, 0, (short unsigned int) image_surface->w, (short unsigned int) image_surface->h};
    if (dst_rect) _dst_rect = *dst_rect;

    SDL_Rect _src_rect = {0, 0, (short unsigned int) surface->w, (short unsigned int) surface->h};
